          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <a class="dropdown-toggle" data-bs-toggle="collapse" href="#q2">
              ...
              <ul class="dropdown-menu collapsed show" id="q2">
                ...
                <li><a class="sidebar-link actived" href="RequestFacility.php">Request Facility</a></li>
      ...
      <div class="page-container">
        ...
        <main class="main-content bgc-grey-100">
          <div id="mainContent">
            <div class="container-fluid">
              <h4 class="c-grey-900 mT-10 mB-30 fw-bold">REQUEST FACILITY</h4>
              <div class="row">
                <div class="col-md-12">
        ...
        <div class="mb-3 float-end">
            <button type="submit" 
                    ...
                    data-bs-target="#reqFacility" 
                    class="btn btn-primary">+ Request Facility
            </button>
        </div>

      <!-- REQUEST FACILITY MODAL -->
            <div class="modal fade" id="reqFacility" aria-labelledby="reqFacility" aria-hidden="true">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                        <h4 class="modal-title fw-bold">REQUEST FACILITY</h4>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                    <!-- Modal body -->
                         <div class="modal-body">
                         <!-- <form action="../../../Controller/RequestFacilitiesQuery" method="POST"> -->
                         <form action="#" method="POST">

                            <div class="mb-3 row">
                              <label for="" class="col-md-5 fw-bold">Facility Type</label>
                                    <div class="col-md-7">
                                    <select class="form-select" 
                                      ...
                                      <option value="Interview Facility">Interview Facility</option>
                                    </select>
                               </div>
                            </div>

                            <div class="mb-3 row">
                                <label for="" class="col-md-5 form-label fw-bold">Request Date From</label>
                              <div class="col-md-7">
                                <input type="date" 
                                       class="form-control" 
                                       name="req_dateFrom"
                            ...
                            <div class="mb-3 row">
                                <label for="" class="col-md-5 form-label fw-bold">Request Date To</label>
                              <div class="col-md-7">
                                <input type="date" 
                                       class="form-control" 
                                       name="req_dateTo"
                                ...
                                <input type="hidden" 
                                       name="requestBy"
                                       value="<?php echo $account['username'] ?>&nbsp;( <?php echo $account['positionTitle'] ?> )">
