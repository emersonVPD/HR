          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <a class="dropdown-toggle" data-bs-toggle="collapse" href="#q5"
              ...
              <ul class="dropdown-menu collapsed show" id="q5">
                <li><a class="sidebar-link actived" href="Certificates.php">Certificates</a></li>
        ...
        <main class="main-content bgc-grey-100">
          <div id="mainContent">
            <div class="container-fluid">
              <h4 class="c-grey-900 mT-10 mB-30 fw-bold">REQUEST CERTIFICATES</h4>
              <div class="row">
                <div class="col-md-12">
                  <div class="bgc-white bd bdrs-3 p-20 mB-20">
                    ...
                    <div class="mb-3 text-end">
                        <button type="submit" 
                                ...
                                class="btn btn-primary">+ Request Certificates
                        </button>
                    </div>

                  <!-- ADD REQUEST CERTIFICATES -->
                        <div class="modal fade" id="reqLegaldocu" aria-labelledby="addSandQ" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                    <h4 class="modal-title fw-bold">REQUEST CERTIFICATES</h4>
                                ...
                                <!-- Modal body -->
                                    ...
                                    <!-- <form action="../../../Controller/RequestLegalDocuQuery.php" method="POST"> -->
                                        ...
                                        <div class="mb-3 row">
                                          <label for="" class="col-md-4 fw-bold">Types of Certificates</label>
                                            <div class="col-md-8">
                                                    ...
                                                    <option selected disabled value="">Select Type of Certificates</option>
                                                    <option value="Employee of the Month">Employee of the Month</option>
                                                    <option value="Most Improved Performer">Most Improved Performer</option>
                  ...
                  <!-- END OF ADD REQUEST CERTIFICATES -->
                    ...
                    <table
                      ...
                      <tbody>
                        <?php
                              ...
                              $sql = mysqli_query($conn, "SELECT * FROM reqlegaldocutbl WHERE 
                                                  req_legal_type = 'Employee of the Month' OR
                                                  req_legal_type = 'Most Improved Performer' OR
                                                  req_legal_type = 'Perfect Attendance' OR
                                                  req_legal_type = 'Employee Promotion' OR
                                                  req_legal_type = 'Certificate of Appreciation'");
                        ...
                        <tr>
                            ...
                            <td>
                                <?php $status = $reqlegaldocu['req_legal_file'];
                                    if ($status);{
                                      if($status == NULL){
                                        echo '<button class="btn btn-secondary btn-sm">No File</button>';}
                                      else{
                            ...
                            <td>
                                ...
                                <div class="modal fade" id="view<?php echo $reqlegaldocu['id'] ?>" aria-labelledby="view" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title fw-bold">VIEW REQUEST CERTIFICATE</h4>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><button class="btn btn-danger btn-sm">
                                                                        <?php echo $reqlegaldocu['req_legal_status'] ?>
                                                                    </button>
                                                                </td>
                                                            </tr>
