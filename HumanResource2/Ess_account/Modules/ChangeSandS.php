          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <a class="dropdown-toggle" data-bs-toggle="collapse" href="#q2"
              ...
              <ul class="dropdown-menu collapsed show" id="q2">
                ...
                <li><a class="sidebar-link actived" href="ChangeSandS.php">Change Shift and Schedule</a></li>
              </ul>
            </li>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="text-end mb-3">
                        <button type="submit" 
                            ...
                            + Request Change Shift and Schedule
                        </button>
                    </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title fw-bold">CHANGE SHIFT and SCHEDULE</h4>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <!-- Modal body -->
                                <div class="modal-body">
                                    <form action="../ClientSide/EmployeeRequest/ChangeSandSQuery.php" method="POST">
                                        <input type="hidden" name="username" value="<?php echo $account['username']; ?>">
                                        <input type="hidden" name="status" value="Pending">
                                        <input type="hidden" name="employeeID" value="<?php echo $account['employeeID']; ?>">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-select" name="shift" aria-label="Floating label select example" required>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-select" name="day1" aria-label="Floating label select example" required>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-select" name="day2" aria-label="Floating label select example" required>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-select" name="day3" aria-label="Floating label select example" required>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-select" name="day4" aria-label="Floating label select example" required>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-select" name="day5" aria-label="Floating label select example" required>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-select" name="dayoff1" aria-label="Floating label select example" required>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-select" name="dayoff2" aria-label="Floating label select example" required>
                                        ...
                                        <div class="mb-3 row">
                                            <label for="" class="col-md-4 form-label fw-bold">Insert Note</label>
                                            <div class="col-md-8">
                          ...
                          <table id="dataTable" class="table table-striped table-bordered"
                            ...
                            <tbody id="myTable">
                                ...
                                $leave = mysqli_query($conn, "SELECT * FROM reqsands WHERE username = '" . $_SESSION['username'] . "'");
                                ...
                                <tr>
                                  ...
                                  <td class="fw-bold" style="width: 45%">
                                  <?php echo $row['day1'];?> / 
                                  <?php echo $row['day2'];?> / 
                                  <?php echo $row['day3'];?> / 
                                  <?php echo $row['day4'];?> / 
                                  ...
                                  <td style="width: 30%">
                                          ...
                                          <div class="modal fade" id="view<?php echo $row['id'] ?>" aria-labelledby="view" aria-hidden="true">
                                              <div class="modal-dialog">
                                                <div class="modal-content">
                                                  <div class="modal-header">
                                                      <h4 class="modal-title fw-bold">VIEW REQUEST CHANGE SHIFT and SCHEDULE</h4>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                      </div>
                                                          ...
                                                          <div class="modal-body">
                                                            ...
                                                            <hr>
                                                              ...
                                                              <div class="text-center">
                                                                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                                  <button type="submit" name="updateApproved" class="btn btn-success">UPDATE</button>
                                                              </div>
