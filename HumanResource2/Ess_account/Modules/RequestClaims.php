          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <a class="dropdown-toggle" data-bs-toggle="collapse" href="#q3"
              ...
              <ul class="dropdown-menu collapsed show" id="q3">
                <li><a class="sidebar-link actived" href="RequestClaims.php">Request Claims</a></li>
        ...
        <main class="main-content bgc-grey-100">
          <div id="mainContent">
            <div class="container-fluid">
              <h4 class="c-grey-900 mT-10 mB-30 fw-bold">REQUEST CLAIMS</h4>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="text-end mb-3">
                        <button type="submit" 
                                ...
                                data-bs-target="#candr" class="btn btn-primary">
                            + Request Claims
                        </button>
                    </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title fw-bold">REQUEST CLAIMS</h4>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <!-- Modal body -->
                                <div class="modal-body">
                                    <form action="../ClientSide/EmployeeRequest/ClaimsReimbursementQuery.php" method="POST">
                                        <input type="hidden" name="username" value="<?php echo $account['username']; ?>">
                                        <div class="mb-3 row">
                                            <label for="" class="col-md-5 fw-bold">Types of Claims</label>
                                            <div class="col-md-7">
                                                <select class="form-select" name="type" aria-label="Floating label select example" required>
                                                    <option selected disabled value="">Select Types of Claims</option>
                                                    <option value="13th Month Pay" class="fw-bold">13th Month Pay</option>
                                                    <option value="Separation Pay" class="fw-bold">Separation Pay</option>
                                                    <option value="Retirement Pay" class="fw-bold">Retirement Pay</option>
                                                    <option value="Back pay" class="fw-bold">Back Pay</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                          ...
                          <table id="dataTable" class="table table-striped table-bordered"
                                  ...
                                  <thead>
                                      <tr>
                                          <th scope="col">Types of Claims</th>
                                  ...
                                  <tbody id="myTable">
                                      ...
                                      ?>
                                      <tr>
                                          <td class="fw-bold" style="width: 40%"><?php echo $row['type']; ?></td>
                                          <td style="width: 40%">
                                              <?php
                                              $status = $row['status'];
                                              if ($status) {
                                          ...
                                          <td style="width: 30%">
                                              ...
                                              <div class="modal fade" id="view<?php echo $row['id'] ?>" aria-labelledby="view" aria-hidden="true">
                                                  <div class="modal-dialog">
                                                      <div class="modal-content">
                                                          <div class="modal-header">
                                                              <h4 class="modal-title fw-bold">VIEW REQUEST CLAIMS</h4>
                                                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                          </div>
                                                          <!-- Modal body -->
                                                          <div class="modal-body">
                                              ...
                                              <div class="modal fade" id="edit<?php echo $row['id'] ?>" aria-labelledby="fillup" aria-hidden="true">
                                                  <div class="modal-dialog">
                                                      <div class="modal-content">
                                                          <div class="modal-header">
                                                              <h4 class="modal-title fw-bold">UPDATE REQUEST CLAIMS</h4>
                                                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                          </div>
                                                          <!-- Modal body -->
                                                          <div class="modal-body">
                                                              <form action="../ClientSide/EmployeeRequest/ClaimsReimbursementQuery.php" method="POST">
                                                                  ...
                                                                  <div class="mb-3 row">
                                                                      <label for="" class="col-md-4 form-label fw-bold">Details</label>
                                                                      <div class="col-md-8">
