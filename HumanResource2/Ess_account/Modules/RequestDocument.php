        ...
        <div class="sidebar-inner">
          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <a class="dropdown-toggle" data-bs-toggle="collapse" href="#q6"
                ...
                <span class="arrow"><i class="ti-angle-right"></i></span
              ></a>
              <ul class="dropdown-menu collapsed show" id="q6">
                <li><a class="sidebar-link actived" href="RequestDocument.php">Request Documents</a></li>
              </ul>
            </li>
          </ul>
        </div>
        ...
        <main class="main-content bgc-grey-100">
          <div id="mainContent">
            <div class="container-fluid">
              <h4 class="c-grey-900 mT-10 mB-30 fw-bold">REQUEST DOCUMENTS</h4>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="text-end mb-3">
                        <button type="submit" 
                                ...
                                data-bs-target="#candr" class="btn btn-primary">+ Request Document
                        </button>
                    </div>
                    ...
                    <div class="modal fade" id="candr" aria-labelledby="addSandQ" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title fw-bold">REQUEST DOCUMENT FILE</h4>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <!-- Modal body -->
                                <div class="modal-body">
                                    <form action="../ClientSide/EmployeeRequest/RequestDocumentQuery.php" method="POST">

                                        <input type="hidden" name="username" value="<?php echo $account['username']; ?>">

                                        <div class="mb-3 row">
                                            <label for="" class="col-md-5 fw-bold">Types of Documents</label>
                                            <div class="col-md-7">
                                                <select class="form-select" name="type" aria-label="Floating label select example" required>
                                                    <option selected disabled value="">Select Type of Documents</option>
                                                    <option value="Curriculum Vitae" class="fw-bold">Curriculum Vitae</option>
                                                    <option value="Contract Paper" class="fw-bold">Contract Paper Copy</option>
                                                    <option value="NBI Clearance" class="fw-bold">NBI Clearance</option>
                                                    <option value="Transcript of Records" class="fw-bold">Transcript of Records.</option>
                                                    <option value="Police Clearance" class="fw-bold">Police Clearance</option>
                                                    <option value="Others" class="fw-bold">If Other Specified in Notes</option>
                                                </select>
                                            </div>
                                        </div>
                        ...
                        <table id="dataTable" class="table table-striped table-bordered"
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col">Types of Document</th>
                                ...
                                <tbody id="myTable">
                                    <?php
                                    $leave = mysqli_query($conn, "SELECT * FROM reqdocument WHERE username = '" . $_SESSION['username'] . "'");
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 30%">
                                            <?php
                                            $status = $row['docs_file'];
                                            if ($status) {
                                                if ($status == NULL) {
                                                    echo '<button class="btn btn-secondary btn-sm pe-none">No File</button>';
                                                } else {
                                                    echo '<a href="../../../public/uploads//reqDocument/' . $row['docs_file'] . '"
                                                    target="_blank"
                                        ...
                                        <td style="width: 15%">
                                            ...
                                            <div class="modal fade" id="view<?php echo $row['id'] ?>" aria-labelledby="view" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title fw-bold">VIEW REQUEST DOCUMENT</h4>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
