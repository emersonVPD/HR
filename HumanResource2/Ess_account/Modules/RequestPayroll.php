          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <a class="dropdown-toggle" data-bs-toggle="collapse" href="#q5"
              ...
              <ul class="dropdown-menu collapsed show" id="q5">
                <li><a class="sidebar-link actived" href="RequestPayroll.php">Request Payslip</a></li>
              </ul>
            </li>
        ...
        <main class="main-content bgc-grey-100">
          <div id="mainContent">
            <div class="container-fluid">
              <h4 class="c-grey-900 mT-10 mB-30 fw-bold">REQUEST PAYSLIP</h4>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="text-end mb-3">
                        <button type="submit" 
                                ...
                                data-bs-target="#reqrow" class="btn btn-primary">+ Request Payslip</button>
                    </div>
                    ...
                    <div class="modal fade" id="reqrow" aria-labelledby="addSandQ" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title fw-bold">REQUEST PAYSLIP COPY</h4>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <!-- Modal body -->
                                <div class="modal-body">
                                    <form action="../ClientSide/EmployeeRequest/RequestPayrollCopyQuery.php" method="POST">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="" class="col-md-5 form-label fw-bold">Year and Month</label>
                                            <div class="col-md-7">
                                                <input type="Month" class="form-control" name="yrmonth" required="required">
                                            </div>
                                        </div>

                                        <div class="mb-3 row">
                                            <label for="" class="col-md-5 fw-bold">Select Quarter</label>
                                            <div class="col-md-7">
                                                <select class="form-select" name="quarter" aria-label="Floating label select example" required>
                                                    <option selected disabled value="">Select Quarter</option>
                                                    <option value="First of Month" class="fw-bold">First of the Month</option>
                                                    <option value="Last of Month" class="fw-bold">Last of the Month</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <input type="hidden" name="datereq">
                        ...
                        <table id="dataTable" class="table table-striped table-bordered"
                                ...
                                <tbody id="myTable">
                                    <?php
                                    $leave = mysqli_query($conn, "SELECT * FROM reqpayroll WHERE username = '" . $_SESSION['username'] . "'");
                                                ...
                                                <td style="width: 15%">
                                                    ...
                                                    <div class="modal fade" id="view<?php echo $row['id'] ?>" aria-labelledby="view" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">VIEW REQUEST PAYSLIP</h4>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
