          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <a class="dropdown-toggle" data-bs-toggle="collapse" href="#q2"
              ...
              <ul class="dropdown-menu collapsed show" id="q2">
                <li><a class="sidebar-link actived" href="ExamModules.php">Exam Modules</a></li>
        ...
        <main class="main-content bgc-grey-100">
          <div id="mainContent">
            <div class="container-fluid">
              <h4 class="c-grey-900 mT-10 mB-30 fw-bold">EXAM MODULES</h4>
                <div class="row">
                    <div class="col-md-12">
                      <div class="bgc-white bd bdrs-3 p-20 mB-20">
                        ...
                        <div class="text-end mb-3">
                            <button type="submit" 
                                    ...
                                    class="btn btn-primary">+ Add Exam Modules
                            </button>
                        </div>
                    ...
                    <!-- ADD MODAL -->
                              ...
                              <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                  <div class="modal-header">
                                        <h4 class="modal-title fw-bold">ADD EXAM MODULES</h4>
                                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                      </div>
                                    <!-- Modal body -->
                                        <div class="modal-body">
                                          <form action="../../../Controller/ExamModulesQuery.php" method="POST">
                                              ...
                                              <div class="col-md-7">
                                                  ...
                                                  <input type="hidden" name="exam_datecrtd"> 

                                              <div class="mb-3 row">
                                                  <label for="" class="col-md-5 fw-bold">Exam Modules Links</label>
                                                <div class="col-md-7">
                                                  <input type="url" 
                          ...
                          <table id="dataTable" class="table table-striped table-bordered"
                                ...
                                <thead>
                                  <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">Exam Module Title</th>
                                    <th scope="col">Date Created</th>
                                    <th scope="col">Exam Module Links</th>
                           ...
                           <tbody id="myTable">
                              ...
                              $sql = mysqli_query($conn, "SELECT * FROM exam_modulestbl");
                              $exam = mysqli_num_rows($sql);
                                  if($exam > 0){
                                      while ($exam = mysqli_fetch_array($sql)) {
                                          # code...
                              ?>

                              <tr>
                                  <td class="fw-bold" style="width: 10%"><?php echo $exam['id'];?></td>
                                  <td class="fw-bold" style="width: 25%"><?php echo $exam['exam_title'];?></td>
                                  <td class="fw-bold" style="width: 25%"><?php $date = $exam['exam_datecrtd'];
                                                            $date = strtotime ($date);
                                                            $date = date ('M j, Y', $date);
                                                            echo $date;?> 
                                  </td>
                                  <td style="width: 25%"><a href="<?php echo $exam['exam_links'];?>" 
                                        target="_blank" 
                                  ...
                                  <td>
                                    <button type="button" 
                                            ...
                                            data-bs-toggle="modal"
                                            title="View"
                                            data-bs-target="#view<?php echo $exam['id'] ?>"><i class="bi bi-eye-fill"></i>
                                    </button>
                                    ...
                                    <button type="button" 
                                            ...
                                            data-bs-toggle="modal"
                                            title="Edit"
                                            data-bs-target="#edit<?php echo $exam['id'] ?>"><i class="bi bi-pencil-fill"></i>
                                    </button>
                                    ...
                                    <button type="button" 
                                            ...
                                            data-bs-toggle="modal"
                                            title="Delete"
                                            data-bs-target="#delete<?php echo $exam['id'] ?>"><i class="bi bi-trash"></i>
                                    </button>

                                    <!-- VIEW MODAL -->
                                    <div class="modal fade" id="view<?php echo $exam['id'] ?>" aria-labelledby="view" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title fw-bold">EXAM MODULE FILE</h4>
                                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                          ...
                                          <div class="modal-body">
                                            <form method="POST">
                                                ...
                                                <table class="table table-striped">
                                                  <tbody>
                                                      <tr><th scope="row">Exam Module ID</th>
                                                        <td><?php echo $exam['id'] ?></td></tr>

                                                      <tr><th scope="row">Exam Module Title</th>
                                                        <td><?php echo $exam['exam_title'] ?></td></tr>

                                                      <tr><th scope="row">Date Created</th>
                                                        <td>
                                                          <?php $date = $exam['exam_datecrtd'];
                                                                $date = strtotime ($date);
                                                      ...
                                                      <tr><th scope="row">Exam Module Links</th>
                                                          <td><a href="<?php echo $exam['exam_links'];?>" 
                                                                  target="_blank" 
                                                                  class="btn btn-primary btn-sm">View Links</a></td>
                                                      </td></tr>
                                    ...
                                    <!-- UPDATE MODAL -->
                                    <div class="modal fade" id="edit<?php echo $exam['id'] ?>" aria-labelledby="fillup" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                  <h4 class="modal-title fw-bold">UPDATE EXAM MODULES</h4>
                                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                      </div>
                                                        <!-- Modal body -->
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo $exam['id'] ?>">
                                                      ...
                                                      <div class="mb-3 row">
                                                        <label for="" class="col-md-5 fw-bold">Exam Module Title</label>
                                                          <div class="col-md-7">
                                                            <select class="form-select"  
                                                                    name="exam_title" 
                                                                    aria-label="Floating label select example"
                                                                ...
                                                                <option value="<?php echo $exam['exam_title'];?>">
                                                      ...
                                                      <div class="mb-3 row">
                                                          <label for="" class="col-md-5 fw-bold">Date Created</label>
                                                        <div class="col-md-7">
                                                          <input type="date" 
                                                                class="form-control" 
                                                                name="exam_datecrtd"
                                                                value="<?php echo $exam['exam_datecrtd'];?>" 
                                                                required="required">
                                                        </div>
                                                      </div>

                                                      <div class="mb-3 row">
                                                          <label for="" class="col-md-5 fw-bold">Current Exam Links</label>
                                                        <div class="col-md-7">
                                                          <a href="<?php echo $exam['exam_links'];?>" 
                                                                  target="_blank" 
                                                                  class="btn btn-primary btn-sm">View Links</a> 
                                                        </div>
                                                      </div>
                                                      ...
                                                      <div class="mb-3 row">
                                                          <label for="" class="col-md-5 fw-bold">Update Exam Links</label>
                                                          <div class="col-md-7">
                                                            <input type="url" 
                                                                  name="exam_links"
                                                                  class="form-control pt-4 pb-4"
                                                                  value="<?php echo $exam['exam_links'];?>"
                                                                  required="required">
                                                          </div>
                                                      </div>
                                    ...
                                    <!-- DELETE MODAL -->          
                                    <div class="modal fade" id="delete<?php echo $exam['id'] ?>" aria-labelledby="view" aria-hidden="true">
                                      <div class="modal-dialog">
                                          <div class="modal-content">
                                              <div class="modal-header">
                                                <h5 class="modal-title fw-bold">DELETE EXAM MODULE</h5>
                                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <form action="../../../Controller/ExamModulesQuery.php" method="POST">
                                                      ...
                                                      <div class="mb-3 row">
                                                          <label for="" class="col-md-4 form-label fw-bold">Exam Title</label>
                                                        <div class="col-md-8">
                                                              <input class="form-control"
                                                                    type="text" 
                                                                    readonly class="form-control-plaintext" 
                                                                    value="<?php echo $exam['exam_title'];?>">
                                                        </div>
                                                      </div>

                                                      <div class="mb-3 row">
                                                          <label for="" class="col-md-4 form-label fw-bold">Current Links</label>
                                                        <div class="col-md-8">
                                                              <a href="<?php echo $exam['exam_links'];?>" 
                                                                      target="_blank" 
                                                                      class="btn btn-primary btn-sm">View Links</a> 
                                                      ...
                                                      <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-8">
                                                              <input class="form-control"
                                                                    type="text" 
                                                                    readonly class="form-control-plaintext" 
                                                                    value="<?php $date = $exam['exam_datecrtd'];
                                                                                  $date = strtotime ($date);
                                                                                  $date = date ('F j, Y', $date);
                                                                                  echo $date;?>">
                                                        </div>
