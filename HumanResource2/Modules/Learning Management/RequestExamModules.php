          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <a class="dropdown-toggle" data-bs-toggle="collapse" href="#q2"
              ...
              <ul class="dropdown-menu collapsed show" id="q2">
                ...
                <li><a class="sidebar-link actived" href="RequestExamModules.php">Request Exam Modules</a></li>
        ...
        <main class="main-content bgc-grey-100">
          <div id="mainContent">
            <div class="container-fluid">
              <h4 class="c-grey-900 mT-10 mB-30 fw-bold">REQUEST EXAM MODULES</h4>
                <div class="row">
                    <div class="col-md-12">
                      <div class="bgc-white bd bdrs-3 p-20 mB-20">
                        ...
                        <!-- <div class="mb-3 text-end">
                          <button type="submit" 
                                  ...
                                  data-bs-target="#reqExamModule" 
                                  class="btn btn-primary">Request Exam Module
                          </button>
                      </div> -->
                                ...
                                <div class="modal-header">
                                  ...
                                  <!-- Modal body -->
                                      ...
                                      <form action="../../../Controller/RequestExamModulesQuery.php" method="POST">
                                          ...
                                          <div class="mb-3 row">
                                            <label for="" class="col-md-5 fw-bold">Purpose</label>
                                              <div class="col-md-7">
                                                <input type="text" 
                                                        class="form-control" 
                                                        name="req_exam_purpose"
                                                        value="Exam"
                                                        required="required">
                                              </div>
                                          </div>
                                          ...
                                          <div class="mb-4 row">
                                              <label for="" class="col-md-5 form-label fw-bold">Exam Modules Links</label>
                                            <div class="col-md-7">
                                  ...
                                  <tr>
                                    ...
                                    <tbody id="myTable">
                                      ...
                                      <tr>
                                          ...
                                          <td class="fw-bold"><?php echo $reqExamModule['req_exam_purpose'];?></td>
                                                      ...
                                                      <tbody>
                                                          ...
                                                          <tr><th scope="row">Job Title</th>
                                                            ...
                                                            <tr><th scope="row">Request Purpose</th>
                                                              <td><?php echo $reqExamModule['req_exam_purpose'] ?>
                                                            </td></tr>
                                        ...
                                        <div class="modal fade" id="edit<?php echo $reqExamModule['id'] ?>" aria-labelledby="fillup" aria-hidden="true">
                                          <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <label for="" class="col-md-5 fw-bold">Request Date</label>
                                                  <div class="col-md-7">
                                                    <input type="date" 
                                                            class="form-control" 
                                                            name="req_exam_date"
                                                            value="<?php echo $reqExamModule['req_exam_date']?>" 
                                                            required="required">
                                                  </div>
                                              </div>
                                                ...
                                                <label for="" class="col-md-5 fw-bold">Purpose</label>
                                                  <div class="col-md-7">
                                                    <input type="text" 
                                                            class="form-control" 
                                                            name="req_exam_purpose"
                                                            value="<?php echo $reqExamModule['req_exam_purpose']?>" 
                                                            required="required">
                                                  </div>
                                              </div>
                                              ...
                                              <div class="mb-4 row">
                                                  <label for="" class="col-md-5 form-label fw-bold">Update Exam Links</label>
                                                <div class="col-md-7">
                                                    <textarea class="form-control" 
                                                              name="req_exam_links"
                                                              rows="5"><?php echo $reqExamModule['req_exam_links'];?></textarea>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="mb-4 row">
                                                ...
                                                <div class="col-md-7">
                                                    <textarea class="form-control"
                                                              type="url" 
                                                              name="req_exam_remarks"
                                                              rows="5"><?php echo $reqExamModule['req_exam_remarks']?></textarea>
                                                  </div>
                                              </div>
                                    ...
                                    <!-- END OF UPDATE MODAL -->
                                                    ...
                                                    <!-- <button type="button" 
                                                            ...
                                                            data-bs-toggle="modal"
                                                            title="Delete"
                                                            data-bs-target="#delete<?php echo $reqExamModule['id'] ?>"><i class="bi bi-trash"></i>
                                                    </button> -->

                                    <!-- DELETE SKILLS AND QUALIFICATIONS DETAILS AND FILES MODAL -->          
                                            <div class="modal fade" id="delete<?php echo $reqExamModule['id'] ?>" aria-labelledby="view" aria-hidden="true">
                                              <div class="modal-dialog modal-lg">
                                                  <div class="modal-content">
                                                      <div class="modal-header">
                                                        <h5 class="modal-title fw-bold">DELETE REQUEST EXAM MODULES</h5>
                                                          <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                                                        </div>

                                                <div class="modal-body">
                                                      <form action="RequestExamModulesQuery.php" method="POST">
                                                      ...
                                                      <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-8">
                                                              <input class="form-control"
                                                                    ...
                                                                    value="<?php echo $reqExamModule['req_exam_title']?>">
                                                        </div>
                                                      </div>

                                      <div class="mb-3 row">
                                            <label for="" class="col-md-4 form-label fw-bold">Exam Module Links</label>
                                          <div class="col-md-8">
                                                              <?php $status = $reqExamModule['req_exam_links'];
                                                                  if ($status);{
                                                                      if($status == NULL)
                                                      ...
                                                      <div class="mb-3 row">
                                                        ...
                                                        <input type="hidden" name="delete_id" value="<?php echo $reqExamModule['id']; ?>">
