          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <a class="dropdown-toggle" data-bs-toggle="collapse" href="#q5"
              ...
              <ul class="dropdown-menu collapsed show" id="q5">
                ...
                <li><a class="sidebar-link actived" href="SubstituteEmployee.php">Substitute From Current Employee</a></li>
              </ul>
            </li>
          </ul>
        </div>
        ...
        <main class="main-content bgc-grey-100">
          <div id="mainContent">
            <div class="container-fluid">
              <h4 class="c-grey-900 mT-10 mB-30 fw-bold">SUBSTITUTE FROM EMPLOYEE</h4>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="mb-2 text-end">
                          <div class="me-2">
                              <button type="submit" 
                                      ...
                                      class="btn btn-primary">Substitute Employee
                              </button>
                          </div>
                        </div>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            <div class="modal-header">
                                  <h4 class="modal-title fw-bold">REQUEST SUBSTITUTE EMPLOYEE</h4>
                                  ...
                                  <div class="modal-body">
                                    <form action="../../../Controller/RequestEmployeeQuery.php" method="POST">
                                        ...
                                        <div class="mb-3 row">
                                          <label for="" class="col-md-5 fw-bold">Select Employee for Substitution</label>
                                          <div class="col-md-7">
                                            <select class="form-control selectpicker"  
                                              ...
                                              <option selected disabled value="">Employee for Substitution</option>

                                              <?php
                                                $query = mysqli_query($conn, "SELECT emp_firstname, emp_middlename, emp_lastname FROM employeetbl");
                                                $num_rows = mysqli_num_rows($query); // Use a different variable name

                                                while ($row = mysqli_fetch_array($query)) {
                                                  echo "<option data-tokens='" . $row['emp_firstname'] . "&nbsp;" . $row['emp_middlename'] . "&nbsp;" . $row['emp_lastname'] . "'>" .
                                                      $row['emp_firstname'] . "&nbsp;" . $row['emp_middlename'] . "&nbsp;" . $row['emp_lastname'] . "</option>";
                                                }
                                              ?>
                                            </select>
                                          </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" name="submitSubs" class="btn btn-primary">Submit</button>
                                        </div>
                                    </form>
                                </div>
                          </div>
                          ...
                          <table id="dataTable" class="table table-striped table-bordered"
                              ...
                              <tbody>
                                      ...
                                      $sql = mysqli_query($conn, "SELECT * FROM reqemployee WHERE purpose = 'Substitute'");
                                      $account = mysqli_num_rows($sql);
                                          if($account  > 0){
                                              while ($account  = mysqli_fetch_array($sql)) {
                                      ?>
                                        ...
                                        <td>
                                          ...
                                          <div class="modal fade" id="view<?php echo $account['id'] ?>" aria-labelledby="view" aria-hidden="true">
                                              <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                  <div class="modal-header">
                                                      <h4 class="modal-title fw-bold">VIEW FOR SUBSTITUTION EMPLOYEE</h4>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                      </div>
                                                    ...
                                                    <div class="modal-body">
                                                      ...
                                                      <div class="row">
                                                          <label for="" class="col-md-5 form-label fw-bold">Employee For Substitution</label>
                                                        <div class="col-md-7">
                                                            <?php echo $account['subs'] ?>
                                                        </div>
                                                      </div>
                                          ...
                                          <div class="modal fade" id="edit<?php echo $account['id'] ?>" aria-labelledby="fillup" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title fw-bold">UPDATE FOR SUBSTITUTION EMPLOYEE</h4>
                                                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                  ...
                                                  <div class="modal-body">
                                                      ...
                                                      <label for="" class="col-md-5 fw-bold">Select Employee for Substitution</label>
                                                        <div class="col-md-7">
                                                                ...
                                                                <option value="<?php echo $account['subs'] ?>">Employee for Substitution</option>
                                                    ...
                                                    <div class="mb-3 row">
                                                      ...
                                                      <div class="mb-3 row">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                            <button type="submit" name="updateSubs" class="btn btn-primary">Update</button>
                                                        </div>
                                                          </form>
                                                  </div>
                                              </div>
                                          ...
                                          <div class="modal fade" id="delete<?php echo $account['id'] ?>" aria-labelledby="view" aria-hidden="true">
                                              <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                      <h5 class="modal-title fw-bold">DELETE SUBSTITUTION EMPLOYEE</h5>
                                                        <button type="button" 
                                                                class="btn-close" 
