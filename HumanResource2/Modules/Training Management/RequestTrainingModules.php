        ...
        <main class="main-content bgc-grey-100">
          <div id="mainContent">
            <div class="container-fluid">
              <h4 class="c-grey-900 mT-10 mB-30 fw-bold">REQUES TRAINING MODULE</h4>
                <div class="row">
                    <div class="col-md-12">
                      <div class="bgc-white bd bdrs-3 p-20 mB-20">
                        ...
                        <div class="mb-3 text-end">
                          <button type="submit" 
                                  ...
                                  data-bs-target="#reqTrainingModule" 
                                  class="btn btn-primary">Request Training Module
                          </button>
                      </div>

                    <!-- ADD LEGAL DOCUMENTS MODAL -->
                          <div class="modal fade" id="reqTrainingModule" aria-labelledby="addSandQ" aria-hidden="true">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <!-- Modal body -->
                                      ...
                                      <form action="RequestTrainingModulesQuery.php" method="POST">
                          ...
                          <thead>
                           ...
                           <tbody>
                            ...
                            $sql = mysqli_query($conn, "SELECT * FROM reqmodules 
                                                                 WHERE req_module_purpose ='Training'");
                              ...
                              <td>
                                              ...
                                              <tbody>
                                                  ...
                                                  <tr><th scope="row">Purpose</th>
                                                    ...
                                                    <tr><th scope="row">Request Date</th>
                                                      <td><?php $date = $reqTrainModule['req_module_date'];
                                                              $date = strtotime ($date);
                                                              $date = date ('F j, Y', $date);
                                                              echo $date;?>
                                                    </td></tr>
                                            ...
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div>
                                              ...
                                              <div class="modal-body">
                                                <form action="../../../Controller/RequestTrainingModulesQuery.php" 
                                                  ...
                                                  <div class="mb-3 row">
                                                    <label for="" class="col-md-5 fw-bold">Job Title Training Module</label>
                                                      <div class="col-md-7">
                                                              <select class="form-select" 
                                                                      name="req_module_title" 
                                                                      aria-label="Floating label select example"
                                                    ...
                                                    <label for="" class="col-md-5 fw-bold">Status</label>
                                                      <div class="col-md-7">
                                                        <input class="form-control fw-bold"
                                                              type="text" 
                                                              readonly class="form-control-plaintext" 
                                                              value="<?php $status = $reqTrainModule['req_module_file'];
                                                                    if ($status);{
                                                                        if($status == NULL)
                                                                        { echo 'Not Delivered';}
                                                                        else { echo 'Delivered'; }
                                                  ...
                                                  <div class="mb-3 row">
                                                      <label for="" class="col-md-5 form-label fw-bold">Current File</label>
                                                    <div class="col-md-7">
                                                              <?php $status = $reqTrainModule['req_module_file'];
                                                                  if ($status);{
                                                                      if($status == NULL)
                                                  ...
                                                  <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-7">
                                                          <p><?php echo $reqTrainModule['req_module_remarks'];?></p>    
                                                      </div>
                                                    </div>
                                ...
                                <!--
                                  <button type="button" 
                                          ...
                                          data-toggle="modal"
                                          title="Delete"
                                          data-target="#delete<?php echo $employee['id'] ?>"><i class="bi bi-trash"></i>
                                  </button> -->
                                ...
                                <!-- DELETE EMPLOYEE DETAILS MODAL -->          
                                        <div class="modal fade" id="delete<?php echo $employee['id'] ?>" aria-labelledby="view" aria-hidden="true">
                                          <div class="modal-dialog">
                                              <div class="modal-content">
                                                  <div class="modal-header">
                                                    <h5 class="modal-title fw-bold">DELETE REQUEST FACILITY</h5>
                                                          <button type="button" 
                                                                  class="btn-close" 
                                                                  data-dismiss="modal" 
                                                                  aria-label="Close">
                                            ...
                                            <div class="modal-body">
                                                <form action="EmployeeInformationQuery.php" method="POST">
