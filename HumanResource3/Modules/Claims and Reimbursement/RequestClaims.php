                          ...
                          <table id="dataTable" class="table table-striped table-bordered"
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $leave = mysqli_query($conn, "SELECT * FROM reqcandr 
                                                                      WHERE type = '13th Month Pay' OR 
                                                                            type = 'Separation Pay' OR 
                                                                            type = 'Retirement Pay' OR 
                                                                            type = 'Back pay'");
                                          ...
                                          <div class="modal fade" id="edit<?php echo $row['id'] ?>" aria-labelledby="fillup" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                  <div class="modal-content">
                                                      ...
                                                      <!-- Modal body -->
                                                      <div class="modal-body">
                                                          <form action="../../../Controller/ClaimsReimbursementQuery.php" method="POST">
                                                              ...
                                                              <div class="mb-3 row">
                                                                  <label for="" class="col-md-4 form-label fw-bold">Types of Claims</label>
                                                                  <div class="col-md-8">
                                                                      <input class="form-control" type="text" readonly class="form-control-plaintext" value="<?php echo $row['type'];?>">
                                                                  </div>
                                                              </div>
                                                              ...
                                                              <div class="mb-3 row">
                                                                  ...
                                                                  <div class="col-md-8">
                                                                      <textarea readonly class="form-control" rows="5"><?php echo $row['note'] ?></textarea>
                                                                  </div>
                                                              </div>
                                                              <hr>
                                                              ...
                                                              <div class="mb-3 row">
                                                                  ...
                                                                  <div class="col-md-8">
                                                                      <select class="form-select" name="status" aria-label="Floating label select example" required>
                                                                          ...
                                                                          <option value="Claimed" class="fw-bold">Claimed</option>
                                                                          <option value="Not Approved" class="fw-bold">Not Approved</option>
