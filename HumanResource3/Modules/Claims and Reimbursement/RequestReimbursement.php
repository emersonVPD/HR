                        ...
                        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.min.js"></script>
                          ...
                          <table id="dataTable" class="table table-striped table-bordered"
                                ...
                                <tbody>
                                    ...
                                    $leave = mysqli_query($conn, "SELECT * FROM reqcandr WHERE type = 'Reimbursement'");
                                          ...
                                          <?php $status = $row['candr_file'];
                                            if ($status);{
                                              if($status == NULL){
                                                ...
                                                echo '<a href="../../../public/uploads/proofReimbursement/'.$row['candr_file'].'"
                                                                target="_blank"
                                                        ...
                                                        <form method="POST">
                                                            ...
                                                            <table class="table table-striped">
                                                              <tbody>
                                                                  ...
                                                                  <tr><th scope="row">Types of Reimbursement</th>
                                                                    <td><?php echo $row['type'];?></td></tr>
                                                                
                                                                  <tr><th scope="row">Proof to Reimburse</th>
                                                                    <td>
                                                                          <?php $status = $row['candr_file'];
                                                                            if ($status);{
                                                                              if($status == NULL){
                                                    ...
                                                    <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    ...
                                                                    <!-- Modal body -->
                                                            <div class="modal-body">
                                                                  <form action="../../../Controller/ClaimsReimbursementQuery.php" 
                                                                        method="POST">
                                                              ...
                                                              <div class="mb-3 row">
                                                                  <label for="" class="col-md-4 form-label fw-bold">Types of Reimbursement</label>
                                                                <div class="col-md-8">
                                                                      <input class="form-control"
                                                                            type="text" 
                                                                            readonly class="form-control-plaintext" 
                                                              ...
                                                              <div class="mb-3 row">
                                                                  <label for="" class="col-md-4 form-label fw-bold">Proof to Reimburse</label>
                                                                <div class="col-md-8">
                                                                  <?php $status = $row['candr_file'];
                                                                            if ($status);{
                                                                              if($status == NULL){
