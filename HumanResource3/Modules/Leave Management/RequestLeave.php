          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <a class="dropdown-toggle" data-bs-toggle="collapse" href="#q4"
              ...
              <ul class="dropdown-menu collapsed show" id="q4">
                <li><a class="sidebar-link actived" href="RequestLeave.php">Request Leaves</a></li>
              </ul>
            </li>
                                ...
                                <td>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                ...
                                                                <!-- Modal body -->
                                                        <div class="modal-body">
                                                              <form action="../../../Controller/RequestLeaveQuery.php" 
                                                                    method="POST">
                                                          ...
                                                          <label for="" class="col-md-4 fw-bold">Status</label>
                                                            <div class="col-md-8">
                                                                    ...
                                                                    <option value="<?php echo $row['lv_status'] ?>">
                                                                                  <?php echo $row['lv_status'] ?>
                                                                    </option>
                                                          ...
                                                          <div class="mb-3 row">
                                                              <label for="" class="col-md-4 form-label fw-bold">Types of Leave</label>
                                                            <div class="col-md-8">
                                                                  <input class="form-control"
                                                                        type="text" 
                                                                        readonly class="form-control-plaintext" 
                                                                        value="<?php echo $row['lv_leave'] ?>">
                                                            </div>
                                                          </div>
                                                          ...
                                                          <div class="mb-3 row">
                                                            ...
                                                            <div class="col-md-8">
                                                                  <input class="form-control"
                                                                        type="text" 
                                                                        readonly class="form-control-plaintext" 
                                                                        value=" <?php $date = $row['lv_datefrom'];
                                                                          $date = strtotime ($date);
                                                                          $date = date ('F j, Y', $date);
                                                                              echo $date;?>">
                                                            </div>
                                                          ...
                                                          <div class="mb-3 row">
                                                                <label for="" class="col-md-5 form-label fw-bold">Proof of Leave</label>
                                                              <div class="col-md-7">
                                                                    <?php $status = $row['proof_file'];
                                                                      if ($status);{
                                                                        if($status == NULL){
                                                          ...
                                                          <div class="mb-3 row">
                                                            ...
                                                            <div class="col-md-8">
                                                                    <textarea readonly 
                                                                              class="form-control" 
                                                                              rows="3"><?php echo $row['lv_note'] ?></textarea>
                                                            </div>
                                                          </div> 
                                        ...
                                        <div class="modal fade" id="delete<?php echo $row['id'] ?>" aria-labelledby="view" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                              <div class="modal-content">
                                                  <div class="modal-header">
                                                    <h5 class="modal-title fw-bold">DELETE LEAVE REQUEST</h5>
                                            ...
                                            <div class="modal-body">
                                                <form action="../../../Controller/RequestLeaveQuery.php" method="POST">
