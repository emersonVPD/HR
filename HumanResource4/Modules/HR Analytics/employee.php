          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <li class="nav-item dropdown">
              <a class="dropdown-toggle" data-bs-toggle="collapse" href="#payrollDropdown"
                ...
                <span class="arrow"><i class="ti-angle-right"></i></span
              ></a>
              <ul class="dropdown-menu" id="payrollDropdown">
            ...
            <a class="dropdown-toggle" data-bs-toggle="collapse" href="#analyticsDropdown"
              ...
              <ul class="dropdown-menu show collapsed" id="analyticsDropdown">
                <li><a class="sidebar-link" href="applicant.php">Applicant</a></li>
                <li><a class="sidebar-link actived" href="employee.php">Employee</a></li>
              </ul>
            </li>
          </ul>
        </div>
        ...
        <main class="main-content bgc-grey-100">
          <div id="mainContent">
            <div class="container-fluid">
              <h4 class="c-grey-900 mT-10 mB-30 fw-bold">EMPLOYEE ANALYTICS</h4>
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div id="employee-hire-chart"></div>
