          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="../Payroll Management/create_payroll.php">Create Payroll</a></li>
                <li><a href="../Payroll Management/RequestPayroll.php">Payroll Request</a></li>
                <li><a href="../Payroll Management/payrollFiles.php">Payroll Files</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              ></a>
              <ul class="dropdown-menu">
                <li><a href="../Compensation Planning Admin/Incentives.php">Incentives</a></li>
                <li><a href="../Compensation Planning Admin/Benefits.php">Benefits</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              ></a>
              <ul class="dropdown-menu">
                <li><a href="../HR Analytics/applicant.php">Applicant</a></li>
                <li><a href="../HR Analytics/employee.php">Employee</a></li>
              </ul>
            </li>
          </ul>
        </div>
                          ...
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <!-- Modal body -->
                                  ...
                                  <form action="JobVacancyQuery.php" method="POST">
                                          ...
                                          <table class="table table-striped">
                                            <tbody>
                                                ...
                                                <tr><th scope="row">Status</th>
                                                    <td><?php $status = $jobvacant['job_available'];
                                                        if ($status);{
                                                          if($status == 0){
                                                             echo '<button class="btn btn-danger btn-sm">Incomplete</button>';}
                                                          else{
